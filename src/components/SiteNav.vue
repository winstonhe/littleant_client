...
<ul :class="{'ul_expanded':siteNivBar_expanded === 'true','ul_collapsed':siteNivBar_expanded !=='true'}">
  ...
  <li @click="GetSettingFromSessionStorage('selectedMenu','1')" v-show="userrole !=8"><a href="#dashboard" style="margin-left:10px;padding:10px;font-size:14px;" :class="{'selected':GetSettingFromSessionStorage('selectedMenu')==='1','unselected':GetSettingFromSessionStorage('selectedMenu')!=='1'}" > <i class="fas fa-braille"></i> My Little Ant</a></li>
  ...
  <li  @click="GetSettingFromSessionStorage('selectedMenu','3')" v-show="userrole>=3&& userrole !=8 "><a href="#groupmonthlymetrics" :class="{'selected':GetSettingFromSessionStorage('selectedMenu')==='3','unselected':GetSettingFromSessionStorage('selectedMenu')!=='3'}" style="margin-left:10px;padding:10px;font-size:14px;"> <i class="fas fa-chart-bar"></i> Monthly Metrics</a></li>
  <li @click="GetSettingFromSessionStorage('selectedMenu','5')" v-show="userrole>=2 && userrole !=8"><a href="#groupresourcestatus"  :class="{'selected':GetSettingFromSessionStorage('selectedMenu')==='5','unselected':GetSettingFromSessionStorage('selectedMenu')!=='5'}" style="margin-left:10px;padding:10px;font-size:14px;">  <i class="fas fa-address-book"></i> Engineers Availability </a></li>
  <li @click="GetSettingFromSessionStorage('selectedMenu','7')" v-show="userrole>=2 && userrole !=8"><a href="#customerfocus"  :class="{'selected':GetSettingFromSessionStorage('selectedMenu')==='7','unselected':GetSettingFromSessionStorage('selectedMenu')!=='7'}" style="margin-left:10px;padding:10px;font-size:14px;">  <i class="fas fa-bullseye"></i> Customer Focus Center</a></li>
